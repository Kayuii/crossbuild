IMAGE = kayuii/gcc:cross
LINUX_TRIPLES = arm-linux-gnueabihf arm-linux-gnueabi aarch64-linux-gnu arm-linux-gnueabihf
...
ALIAS_TRIPLES = arm armhf arm64 amd64 x86_64 osx darwin windows
